...
A interface está disponível em **português e inglês**; o seletor fica no topo da
barra lateral. O visual usa uma paleta de tons terrosos definida em um único
módulo (`src/acquisition_lab/viz/theme.py`), e todos os textos vivem em
